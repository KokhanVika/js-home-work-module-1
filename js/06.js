...
// function calcBMI({ weight, height }) {// weight, height берем в фигурные скрбки
...
//  свойствами companyName и stock и выводила репорт о количестве товаров 
...
//   for (const value of values) { // values заменили на Object.values(stock)
//     total += value;
//   }
...
// Дополни функцию createContact(partialContact) так, чтобы она возвращала
//  новый объект контакта с добавленными свойствами id и createdAt, а также
//   list со значением "default" если в partialContact нет такого свойства.
